...
<p>더 자세한 정보는 <a href=\"https://voscms.com\">voscms.com</a>을 방문해 주세요.</p>',
  ...
  'zh_TW' => '<h2>感謝您安裝 VosCMS！</h2><p>VosCMS 是基於外掛的開源 CMS，支援 13 種語言，提供靈活的版面系統。</p><h3>主要功能</h3><ul><li><strong>外掛系統</strong> — 透過外掛擴展功能。</li><li><strong>小工具建構器</strong> — 拖放建構頁面。</li><li><strong>多語言</strong> — 開箱支援 13 種語言。</li><li><strong>深色模式</strong> — 管理面板和前端均支援。</li><li><strong>面板與佈景主題</strong> — 用面板和佈景主題更改設計。</li></ul>',
        ...
        [
            'board_slug'=>'qna',
            'cat_slug'=>null,
            'title'=>'비밀번호를 어떻게 재설정하나요?',
            'content'=>'<p>비밀번호를 잊어버렸습니다. 어떻게 재설정하나요?<br></p>',
            'nick_name'=>'User',
            'is_notice'=>0,
            'original_locale'=>'ko',
            'orig_id'=>3,
            'title_translations'=>[
                ...
                'ja' => 'パスワードはどうやってリセットしますか？',
                'zh_CN' => '如何重置密码？',
                'zh_TW' => '如何重設密碼？',
                'de' => 'Wie setze ich mein Passwort zurück?',
                'es' => '¿Cómo restablezco mi contraseña?',
                'fr' => 'Comment réinitialiser mon mot de passe ?',
                'id' => 'Bagaimana cara mengatur ulang kata sandi saya?',
                'mn' => 'Нууц үгээ хэрхэн сэргээх вэ?',
                'ru' => 'Как сбросить пароль?',
                'tr' => 'Şifremi nasıl sıfırlayabilirim?',
                'vi' => 'Làm thế nào để đặt lại mật khẩu của tôi?',
            ],
            'content_translations'=>[
                'en' => '<p>I forgot my password. How can I reset it?<br></p>',
                'ja' => '<p>パスワードを忘れてしまいました。どうやってリセットしますか？<br></p>',
                'zh_CN' => '<p>我忘记了密码。如何重置？<br></p>',
                'zh_TW' => '<p>我忘記了密碼。如何重設？<br></p>',
                'de' => '<p>Ich habe mein Passwort vergessen. Wie kann ich es zurücksetzen?<br></p>',
                'es' => '<p>Olvidé mi contraseña. ¿Cómo puedo restablecerla?<br></p>',
                'fr' => "<p>J'ai oublié mon mot de passe. Comment le réinitialiser ?<br></p>",
                'id' => '<p>Saya lupa kata sandi. Bagaimana cara mengatur ulang?<br></p>',
                'mn' => '<p>Нууц үгээ мартсан. Хэрхэн сэргээх вэ?<br></p>',
                'ru' => '<p>Я забыл пароль. Как его сбросить?<br></p>',
                'tr' => '<p>Şifremi unuttum. Nasıl sıfırlayabilirim?<br></p>',
                'vi' => '<p>Tôi quên mật khẩu. Làm thế nào để đặt lại?<br></p>',
            ],
        ],
    ],

    // 댓글 시드 (post 의 orig_id 로 연결, parent_id 도 orig_id 로 매핑)
    'comments' => [
        [
            'board_slug' => 'qna',
            'orig_post_id' => 3,
            ...
            'orig_parent_id' => null,
            'depth' => 0,
            'content' => '로그인 페이지에서 "비밀번호 찾기"를 클릭하고 등록된 이메일을 입력하세요. 비밀번호 재설정 링크가 이메일로 전송됩니다.',
            'nick_name' => 'VosCMS',
            'is_anonymous' => 0,
            'is_secret' => 0,
            'content_translations' => [
                'en' => 'Click "Forgot Password" on the login page and enter your registered email. A password reset link will be sent to your email.',
                'ja' => 'ログインページで「パスワードを忘れた方」をクリックし、登録されたメールアドレスを入力してください。パスワードリセットのリンクがメールで送信されます。',
                'zh_CN' => '在登录页面点击"忘记密码"，输入您注册的邮箱。密码重置链接将通过邮件发送给您。',
                'zh_TW' => '在登入頁面點擊「忘記密碼」，輸入您註冊的電子郵件。密碼重設連結將透過郵件發送給您。',
                'de' => 'Klicken Sie auf der Login-Seite auf "Passwort vergessen" und geben Sie Ihre registrierte E-Mail-Adresse ein. Ein Link zum Zurücksetzen des Passworts wird per E-Mail gesendet.',
                'es' => 'Haga clic en "¿Olvidó su contraseña?" en la página de inicio de sesión e ingrese el correo electrónico registrado. Se enviará un enlace de restablecimiento por correo electrónico.',
                'fr' => 'Cliquez sur "Mot de passe oublié" sur la page de connexion et entrez votre email enregistré. Un lien de réinitialisation du mot de passe sera envoyé par email.',
                'id' => 'Klik "Lupa Kata Sandi" di halaman login dan masukkan email yang terdaftar. Tautan untuk mengatur ulang kata sandi akan dikirim ke email Anda.',
                'mn' => 'Нэвтрэх хуудсан дээрх "Нууц үг мартсан" дээр дарж бүртгэлтэй имэйлээ оруулна уу. Нууц үг сэргээх холбоос таны имэйлд илгээгдэнэ.',
                'ru' => 'На странице входа нажмите "Забыли пароль" и введите зарегистрированный email. Ссылка для сброса пароля будет отправлена на вашу почту.',
                'tr' => 'Giriş sayfasında "Şifremi Unuttum"a tıklayın ve kayıtlı e-postanızı girin. Şifre sıfırlama bağlantısı e-posta ile gönderilecektir.',
                'vi' => 'Nhấp vào "Quên mật khẩu" trên trang đăng nhập và nhập email đã đăng ký. Liên kết đặt lại mật khẩu sẽ được gửi đến email của bạn.',
            ],
        ],
        [
            'board_slug' => 'qna',
            ...
            'is_secret' => 0,
            'content_translations' => [
                'en' => 'Test answer', 'ja' => 'テスト回答',
                'zh_CN' => '测试回复', 'zh_TW' => '測試回覆',
                'de' => 'Test-Antwort', 'es' => 'Respuesta de prueba',
                'fr' => 'Réponse test', 'id' => 'Jawaban uji',
                'mn' => 'Туршилтын хариу', 'ru' => 'Тестовый ответ',
                'tr' => 'Test cevabı', 'vi' => 'Câu trả lời thử nghiệm',
            ],
        ],
        [
            'board_slug' => 'qna',
            ...
            'content_translations' => [
                ...
                'ja' => 'ご回答ありがとうございます。',
                'zh_CN' => '感谢您的回答。', 'zh_TW' => '感謝您的回答。',
                'de' => 'Vielen Dank für die Antwort.',
                'es' => 'Gracias por la respuesta.',
                'fr' => 'Merci pour la réponse.',
                'id' => 'Terima kasih atas jawabannya.',
                'mn' => 'Хариулсанд баярлалаа.',
                'ru' => 'Спасибо за ответ.',
                'tr' => 'Cevap için teşekkürler.',
                'vi' => 'Cảm ơn câu trả lời.',
            ],
        ],
    ],
];
