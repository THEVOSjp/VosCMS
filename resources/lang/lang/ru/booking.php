...
return [
    ...
    'staff_designation_guide' => 'Для записи к определённому сотруднику перейдите на страницу сотрудников',
    'go_staff_booking' => 'Запись к сотруднику',
    ...
    'success' => 'Бронирование завершено!',
    'success_desc' => 'Подтверждение будет отправлено. Пожалуйста, сохраните номер бронирования.',
    ...
    'detail' => [
        ...
        'duration_unit' => 'мин',
        'staff_not_assigned' => 'Не назначен',
    ...
    'payment' => [
        ...
        'needs_payment' => 'Требуется оплата',
        'needs_payment_desc' => 'Бронирование будет подтверждено после оплаты.',
        'pay_now' => 'Оплатить',
        'charge_amount' => 'Сумма к оплате',
        'back_to_detail' => 'Вернуться к деталям бронирования',
        'loading' => 'Загрузка оплаты...',
        'deposit' => 'Предоплата',
        'deposit_notice' => 'Оставшаяся сумма оплачивается на месте.',
        'retry' => 'Повторить оплату',
        'cancel_reservation' => 'Отменить бронирование',
        'applied_price' => 'цена со скидкой',
    ],
