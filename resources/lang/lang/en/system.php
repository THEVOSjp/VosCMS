...
return [
    ...
    'updates' => [
        ...
        'available_short' => 'update available',
        'update_recommend' => 'We recommend updating for the latest features and security patches.',
        'full_update' => 'Full Update',
        'patch_update' => 'Patch Update',
        'compare_files' => 'View Changed Files',
        'comparing' => 'Comparing...',
        'compare_failed' => 'File comparison failed.',
        'no_changes' => 'No files have changed.',
        'too_many_changes' => 'Too many changed files for patch update. Please use full update instead.',
        'added_files' => 'Added Files',
        'modified_files' => 'Modified Files',
        'removed_files' => 'Removed Files',
        'changed_files' => 'File Comparison',
        'patch_desc' => 'Downloads only changed files individually. Faster but full update is recommended for large changes.',
        'full_desc' => 'Downloads the complete package for update. The most stable method.',
        'confirm_patch' => 'Proceed with patch update? Only changed files will be downloaded.',
    ],
];
