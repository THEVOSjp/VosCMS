        ...
        <main class="flex-1 ml-64">
            ...
            <div class="p-6">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm transition-colors">
                    ...
                    <?php
                    $systemSlugs = ['terms', 'privacy', 'data-policy', 'refund-policy', 'home'];
                    ...
                    <div class="p-4 flex items-center justify-between hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition border-t border-zinc-100 dark:border-zinc-700/50">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <?php endif; ?>
                            <a href="<?= $adminUrl ?>/site/pages/settings?slug=<?= urlencode($_up['page_slug']) ?>" class="px-3 py-1.5 text-sm text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-lg transition" title="<?= __('common.settings') ?? '설정' ?>">
                            ...
                            <a href="<?= $_upEditUrl ?>" class="px-3 py-1.5 text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-900/30 rounded-lg transition">
                                <?= __('admin.buttons.edit') ?>
                            </a>
                            <a href="<?= $baseUrl ?>/<?= htmlspecialchars($_up['page_slug']) ?>" target="_blank" class="px-3 py-1.5 text-sm text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300 rounded-lg transition" title="<?= __('common.preview') ?? '미리보기' ?>">
