    ...
    <div class="flex">
        ...
        <main class="flex-1 ml-64">
            ...
            <header class="bg-white dark:bg-zinc-800 shadow-sm h-16 flex items-center justify-between px-6 transition-colors">
                <h1 class="text-xl font-semibold text-zinc-900 dark:text-white"><?= __('admin.site.pages.title') ?></h1>
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400"><?= __('admin.site.pages.description') ?></p>
                    </div>
