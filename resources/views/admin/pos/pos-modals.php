                ...
                <div class="md:col-span-2 border-t md:border-t-0 border-zinc-200 dark:border-zinc-700">
                    ...
                    <div id="posReceiptArea" class="px-4 pt-3 pb-1 hidden">
                        <div class="flex gap-2">
                            <a id="posReceiptLink" href="#" target="_blank" class="flex-1 h-9 flex items-center justify-center gap-1.5 text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-800 transition">
