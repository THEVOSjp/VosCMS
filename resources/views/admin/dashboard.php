 ...
 */
$pageTitle = '대시보드 - ' . ($config['app_name'] ?? 'RezlyX') . ' Admin';
    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-zinc-950 min-h-screen fixed">
            <div class="p-6">
                <a href="<?php echo $adminUrl; ?>" class="text-xl font-bold text-white">
                    ...
                    <span class="text-blue-400 text-sm ml-1">Admin</span>
                </a>
            </div>
            <nav class="mt-6">
                <a href="<?php echo $adminUrl; ?>" class="flex items-center px-6 py-3 text-white bg-blue-600">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                    </svg>
                    대시보드
                </a>
                <a href="<?php echo $adminUrl; ?>/reservations" class="flex items-center px-6 py-3 text-zinc-300 hover:bg-zinc-800 hover:text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    예약 관리
                </a>
                <a href="<?php echo $adminUrl; ?>/services" class="flex items-center px-6 py-3 text-zinc-300 hover:bg-zinc-800 hover:text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                    </svg>
                    서비스 관리
                </a>
                <a href="<?php echo $adminUrl; ?>/members" class="flex items-center px-6 py-3 text-zinc-300 hover:bg-zinc-800 hover:text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
                    회원 관리
                </a>
                <a href="<?php echo $adminUrl; ?>/points" class="flex items-center px-6 py-3 text-zinc-300 hover:bg-zinc-800 hover:text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    적립금 관리
                </a>
                <a href="<?php echo $adminUrl; ?>/settings" class="flex items-center px-6 py-3 text-zinc-300 hover:bg-zinc-800 hover:text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="absolute bottom-0 w-64 p-6 border-t border-zinc-800/50">
                <a href="<?php echo $baseUrl; ?>" class="flex items-center text-zinc-400 hover:text-white text-sm">
        ...
        <main class="flex-1 ml-64">
            ...
            <header class="bg-white dark:bg-zinc-800 shadow-sm h-16 flex items-center justify-between px-6 transition-colors">
                <h1 class="text-xl font-semibold text-zinc-900 dark:text-white">대시보드</h1>
