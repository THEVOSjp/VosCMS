...
<body class="bg-zinc-100 dark:bg-zinc-900 min-h-screen transition-colors">
    <div class="flex">
        ...
        <main class="flex-1 ml-64">
            <?php $pageHeaderTitle = __('reservations.pos_settings'); include __DIR__ . '/../partials/admin-topbar.php'; ?>
            <div class="p-6 max-w-3xl">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="<?= $adminUrl ?>/reservations/pos" class="px-4 py-2 text-sm font-medium text-zinc-600 dark:text-zinc-300 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-700 transition">
                        <?= __('reservations.pos') ?>
                    </a>
                </div>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <select name="pos_card_size" class="<?= $inp ?>">
                            ...
                            <label class="flex items-center justify-between">
                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?= __('reservations.pos_settings_show_image') ?></span>
                            ...
                            <!-- 가격 표시 -->
                            <label class="flex items-center justify-between">
                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?= __('reservations.pos_settings_show_price') ?></span>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <!-- 전화번호 표시 -->
                            <label class="flex items-center justify-between">
                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?= __('reservations.pos_settings_show_phone') ?></span>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <select name="pos_default_tab" class="<?= $inp ?>">
                    ...
                    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
                        ...
                        <div class="space-y-4">
                            <!-- 자동 새로고침 -->
                            <label class="flex items-center justify-between">
                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?= __('reservations.pos_settings_auto_refresh') ?></span>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <!-- 알림음 -->
                            <label class="flex items-center justify-between">
                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?= __('reservations.pos_settings_sound') ?></span>
                                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <label class="flex items-center justify-between">
                                <div>
                                    <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?= __('reservations.pos_settings_require_staff') ?></span>
                                    <p class="text-xs text-zinc-500"><?= __('reservations.pos_settings_require_staff_help') ?></p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
