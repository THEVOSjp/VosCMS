    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto relative">
            ...
            <div class="sticky top-0 bg-white dark:bg-zinc-800 px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 flex items-center justify-between rounded-t-2xl z-10">
                <h2 id="staffModalTitle" class="text-lg font-semibold text-zinc-900 dark:text-white"><?= __('admin.staff.create') ?></h2>
            ...
            <form id="staffForm" class="p-6 space-y-4">
                ...
                <!-- 이름 -->
                <div>
                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1"><?= __('admin.staff.fields.name') ?> <span class="text-red-500">*</span></label>
                    <input type="text" id="staffName" name="name" required
                           ...
                           placeholder="<?= __('admin.staff.placeholder.name') ?>">
                </div>
                ...
                <div>
                    ...
                    <input type="email" id="staffEmail" name="email"
                           class="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                           placeholder="<?= __('admin.staff.placeholder.email') ?>">
                </div>
                ...
                <div>
                    ...
                    <input type="tel" id="staffPhone" name="phone"
                           class="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                           placeholder="<?= __('admin.staff.placeholder.phone') ?>">
                </div>

                <!-- 카드번호 (RFID/NFC) -->
                <div>
                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1"><?= __('admin.staff.fields.card_number') ?></label>
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 mb-1"><?= __('admin.staff.card_number_desc') ?></p>
                    <div class="relative">
                        <input type="text" id="staffCardNumber" name="card_number"
                               ...
                               placeholder="<?= __('admin.staff.placeholder.card_number') ?>">
                ...
                <!-- 소개 -->
                <div>
                    <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1"><?= __('admin.staff.fields.bio') ?></label>
                    <textarea id="staffBio" name="bio" rows="3"
                              ...
                              placeholder="<?= __('admin.staff.placeholder.bio') ?>"></textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="max-h-40 overflow-y-auto border border-zinc-200 dark:border-zinc-600 rounded-lg p-3 space-y-2">
                        ...
                        <p class="text-xs text-zinc-400"><?= __('admin.staff.no_services') ?></p>
                        <?php else: ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-sm text-zinc-700 dark:text-zinc-300"><?= __('admin.staff.fields.is_active') ?></span>
                </div>
            </form>
