    ...
    <div class="p-5 space-y-5">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
                ...
                <p class="text-sm font-semibold text-zinc-900 dark:text-white"><?= htmlspecialchars($capacity) ?></p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?= (int)$sub['billing_amount'] > 0 ? $fmtPrice($sub['unit_price'], $sub['currency']) . '/월' : '무료' ?></p>
            </div>
            <div>
        ...
        <div class="pt-3 border-t border-gray-100 dark:border-zinc-700 flex flex-wrap gap-2">
            ...
            <button disabled class="px-3 py-1.5 text-xs text-zinc-400 border border-zinc-200 dark:border-zinc-600 rounded-lg cursor-not-allowed opacity-50" title="준비중">용량 추가</button>
        </div>
    </div>
</div>
