...
?>
<div class="bg-white dark:bg-zinc-800 rounded-xl border border-gray-200 dark:border-zinc-700 p-4 mb-3">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <?php if ($sc === 'one_time'): ?>
                ...
                <span class="text-xs px-2.5 py-1 bg-green-50 text-green-600 dark:bg-green-900/20 dark:text-green-400 rounded-lg flex items-center gap-1">
                ...
                <span class="text-xs px-2.5 py-1 bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 rounded-lg">접수</span>
                <?php elseif ($sub['status'] === 'suspended'): ?>
                <span class="text-xs px-2.5 py-1 bg-zinc-100 text-zinc-500 dark:bg-zinc-700 dark:text-zinc-400 rounded-lg">보류</span>
                <?php elseif ($sub['status'] === 'cancelled'): ?>
                <span class="text-xs px-2.5 py-1 bg-red-50 text-red-500 dark:bg-red-900/20 dark:text-red-400 rounded-lg">취소</span>
                <?php else: ?>
                <span class="text-xs px-2.5 py-1 bg-amber-50 text-amber-600 dark:bg-amber-900/20 dark:text-amber-400 rounded-lg">진행</span>
                <?php endif; ?>
    ...
    <div class="mt-2 text-xs text-zinc-400 flex items-center gap-3">
        <?php if ($sc !== 'one_time'): ?>
